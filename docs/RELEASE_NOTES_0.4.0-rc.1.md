...
The candidate introduces `iicp.management-friction-evidence.v2` and related
trial-session contracts. Existing version 1 friction evidence and the 0.3.0
authorized-local sandbox remain unchanged.

All evidence is observer-declared and non-authorizing. Numerical coverage does
