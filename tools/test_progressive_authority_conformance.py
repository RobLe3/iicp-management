...
RUNNER = ROOT / "tools" / "run_progressive_authority_conformance.py"
FIXTURE = ROOT / "fixtures" / "progressive-authority-conformance-v1.json"


class ProgressiveAuthorityConformanceTest(unittest.TestCase):
